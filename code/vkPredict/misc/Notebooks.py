# Copied from https://github.com/yaroslavvb/stuff/blob/master/notebook_util.py
...
def setup_one_gpu():
    ...
    assert not 'torch' in sys.modules, "GPU setup must happen before importing torch"
